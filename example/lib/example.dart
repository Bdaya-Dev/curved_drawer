...
class _PlaygroundState extends State<Playground> {
  ...
  List<DrawerItem> _drawerItems = <DrawerItem>[
    DrawerItem(
        image: 'assets/a003.png',
        textStyle: TextStyle(color: Colors.red),
        label: "application application application application application"),
    DrawerItem(
        image: 'assets/i001.png',
        textStyle: TextStyle(color: Colors.blue),
        label: "People"),
    DrawerItem(
        image: 'assets/i003.png',
        textStyle: TextStyle(color: Colors.blue, fontSize: 25.0),
        label: "People"),
    DrawerItem(
        image: 'assets/i004.png',
        textStyle: TextStyle(color: Colors.blue, fontSize: 25.0),
        label: "People"),
    DrawerItem(
        image: 'assets/i005.png',
        textStyle: TextStyle(color: Colors.blue, fontSize: 25.0),
        label: "People"),
    DrawerItem(
        image: 'assets/i006.png',
        textStyle: TextStyle(color: Colors.blue, fontSize: 25.0),
        label: "People"),
    DrawerItem(
        image: 'assets/i007.png',
        textStyle: TextStyle(color: Colors.blue, fontSize: 25.0),
        label: "People"),
    DrawerItem(
        image: 'assets/i007.png',
